        ...
        <main className="grid flex-1 items-start gap-4 p-4 sm:px-6 sm:py-0 md:gap-8">
          <div className="chart-wrapper mx-auto flex max-w-6xl flex-col flex-wrap items-start justify-center gap-6 p-6 sm:flex-row sm:p-8">
            <div className="grid w-full gap-6 sm:grid-cols-2 lg:max-w-[22rem] lg:grid-cols-1 xl:max-w-[25rem]">
              <Card
                className="lg:max-w-md hover:ring-[3px] hover:ring-gray-600 dark:hover:ring-gray-200 hover:duration-500"
              ...
              <Card
                className="flex flex-col lg:max-w-md hover:ring-[3px] hover:ring-gray-600 dark:hover:ring-gray-200 hover:duration-500"
            ...
            <div className="grid w-full flex-1 gap-6 lg:max-w-[20rem]">
              <Card
                className="max-w-xs hover:ring-[3px] hover:ring-gray-600 dark:hover:ring-gray-200 hover:duration-500"
