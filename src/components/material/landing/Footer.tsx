...
function Footer() {
  return (
    <footer className="w-full bg-[#121212] text-white py-16 px-[5vh]">
      <div className="max-w-8xl mx-auto ">
        ...
        <div className="flex flex-row justify-between">
          ...
          <div className="flex-col space-y-6 flex  w-[400px]">
            ...
            <p className="text-white font-extralight text-sm leading-relaxed">
          ...
          <div className="space-y-4">
            <h3 className="text-[22px] font-light text-[#ABFA54]">Navigation</h3>
            <ul className="space-y-2">
              <li>
                <Link
                  href="/"
                  className="text-white font-extralight text-[14px] hover:text-white transition-colors"
                >
                  Home
                </Link>
              </li>
          ...
          {/* Our Solution Column */}
          <div className="space-y-4">
            <h3 className="text-[22px] font-light text-[#ABFA54]">
              Our Solution
            </h3>
            <ul className="space-y-2">
              <li>
          ...
          <div className="space-y-6">
            <div className="space-y-4">
              <h3 className="text-lg font-light text-[#ABFA54]">Contact</h3>
            ...
            <div className="space-y-4">
              ...
              <div className="flex space-x-4">
                <Link
                  href="#"
                  className="w-10 h-10 bg-[#000000] rounded-full flex items-center justify-center hover:bg-gray-700 transition-colors"
                >
