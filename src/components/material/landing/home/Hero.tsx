...
const motto = (
  <div className="leading-[80px] text-[#EAEAEA] mt-20 text-[84px] font-normal">
    Bridging Tradition and <br />
...
const desc = (
  <div className="text-[#EAEAEA] text-center font-[100] text-[36px] mt-[50px]">
    Human-centered technology solutions that empower <br /> SMEs, education, and
    industry in Indonesia to digitally <br /> transform.
  </div>
);
