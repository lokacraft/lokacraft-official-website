...
function ContactBanner() {
      return (
            <ParallaxBanner
                  layers={[
                  { image: '/images/portfolio/bottomBanner.png', speed: -30 },
                  ]}
            ...
            >
                  ...
                  <h1 className="text-5xl 2xl:text-8xl font-thin text-center 2xl:text-left">Let&apos;s Create Your Success Story</h1>
