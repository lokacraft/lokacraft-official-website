...
function Hero() {
      const words = `From website development to AI/ML implementation, we provide integrated digital solutions designed to drive your business growth and efficiency.`
  return (
    <div className="w-full h-[75vh] relative flex items-center justify-center">
      ...
      <div className="absolute top-0 left-0 w-screen h-full flex flex-col justify-center gap-y-8 p-8">
            <h1 className="text-4xl lg:text-5xl w-full lg:w-[50%]">Comprehensive Technology Services for Every Business Scale</h1>
