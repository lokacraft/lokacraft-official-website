...
export const PinContainer = ({
  ...
  const onMouseEnter = () => {
    setTransform("translate(-50%,-50%) rotateX(70deg) scale(0.85)");//ubah yang ini
  };
  const onMouseLeave = () => {
  ...
  return (
    ...
    >
      <div
        style={{
          perspective: "350px",//ubah yang ini
          transform: "rotateX(120deg) translateZ(0deg)",
        }}
      ...
      >
        <div
          ...
          className="absolute left-1/2 p-4 top-1/2  flex justify-start items-start  rounded-2xl  shadow-[0_8px_16px_rgb(0_0_0/0.4)] bg-white border border-white/[0.9] group-hover/pin:border-white/[0.9] transition duration-700 overflow-hidden"
        >
